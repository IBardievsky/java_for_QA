...
public class CreationNewContact {
  ...
  public void testCeationNewContact() {
    goToAddContactPage();
    fillNewContactFields(new NewContactData("Vasya", "Pupkin", "Vaxa", "CHESM", "123456789", "vpupa@test.go"));
  ...
  private void fillNewContactFields(NewContactData newContactData) {
